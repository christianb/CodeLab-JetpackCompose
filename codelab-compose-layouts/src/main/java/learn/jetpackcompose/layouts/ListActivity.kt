 ...
 * which is a performance issue when the list size gets bigger. To avoid this problem, use LazyColumn
 */
@Composable
fun SimpleList() {
...
@Composable
fun ImageListItem(index: Int, imagePainter: ImagePainter) {
